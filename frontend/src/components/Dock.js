...
const Dock = ({ position = 'bottom', collapsible = false, responsive = 'bottom' }) => {
  ...
  const dockItems = [
    <img src="https://img.icons8.com/color/48/linkedin.png" alt="AM Logo" style={{ width: '40px', height: '40px' }} />,
    <img src="https://img.icons8.com/color/48/youtube-play.png" alt="AM Logo" style={{ width: '40px', height: '40px' }} />,
    <img src="https://img.icons8.com/tiny-color/48/github.png" alt="AM Logo" style={{ width: '40px', height: '40px' }} />,
    <img src="https://img.icons8.com/3d-fluency/94/instagram-new.png" alt="AM Logo" style={{ width: '40px', height: '40px' }} />,
  ];
