...
const App = () => {
  ...
  const handleUpload = async (files) => {
    ...
    try {
      const response = await axios.post('https://quickdrop-backend.onrender.com/upload', formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
      
      setUploadedFiles(response.data.files);
      setNgrokUrl('https://quickdrop-backend.onrender.com' + response.data.zipUrl);
    } catch (error) {
